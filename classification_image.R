rm(list = ls())
setwd('/home/tapas/Downloads/fashion_data/')
...
load_mnist <- function() {
  ...
  trainData <<- load_image_file('train-images-idx3-ubyte.gz')
  testData <<- load_image_file('t10k-images-idx3-ubyte.gz')
  
  trainData$y <<- load_label_file('train-labels-idx1-ubyte.gz')
  testData$y <<- load_label_file('t10k-labels-idx1-ubyte.gz')  
}
...
runTest('test/shirt1-28x28.png', fit)
runTest('test/shirt2-28x28.png', fit)
runTest('test/shirt3-28x28.png', fit)
runTest('test/pants1-28x28.png', fit)
runTest('test/pants2-28x28.png', fit)
runTest('test/sneaker1-28x28.png', fit)
runTest('test/sneaker2-28x28.png', fit)
